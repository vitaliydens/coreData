...
//    MARK:- Property
    ...
    lazy var frc = { () -> NSFetchedResultsController<Student> in
...
//    MARK: - Custom
    private func showAlert() {
        ...
        alert.addAction(UIAlertAction(title: "OK", style: .default, handler: { [weak alert] (_) in
            ...
            let student = Student(context: self.coreData.persistentContainer.viewContext)
            student.name = name
            student.surName = surName
            student.id = UUID.init().uuidString
            self.saveCoreData()
        }))
...
extension StudentsViewController: NSFetchedResultsControllerDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let markVC = storyboard?.instantiateViewController(withIdentifier: "MarksViewController") as! MarksViewController
        markVC.student = student
